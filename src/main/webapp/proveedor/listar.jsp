...
%>
<main>
    <a class="supplierRegisterButton registerButton" href="registrar.jsp">
        <i class="fa-solid fa-plus fa-xl" style="color: #ffffff;"></i>
        Agregar proveedor
    </a>
  <div class="tableContainer">
    <table>
      <thead class="supplierTableHead">
      <tr>
<%--        <th>ID</th>--%>
        <th>Razón social</th>
        <th>Representante</th>
