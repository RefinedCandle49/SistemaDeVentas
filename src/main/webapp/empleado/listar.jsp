...
%>
<main>
    <a class="employeeRegisterButton registerButton" href="registrar.jsp">
        <i class="fa-solid fa-plus fa-xl" style="color: #ffffff;"></i>
        Agregar empleado
    </a>
    <div class="tableContainer">
        <table>
            <thead class="employeeTableHead">
            <tr>
<%--                <th>ID</th>--%>
                <th>Apellido</th>
                <th>Nombre</th>
